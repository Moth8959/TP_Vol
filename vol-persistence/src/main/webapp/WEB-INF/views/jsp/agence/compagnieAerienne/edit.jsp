...
<body>
	...
	<div class="container">
		<fieldset>
   			<legend><spring:message code="compagnie.edit.form"/></legend>
			 <form:form modelAttribute="compagnieAerienne" action="save" method="post">
				<form:hidden class="form-control" path="id" /> 
				<form:hidden class="form-control" path="version" /> 
				 <div class="form-group">
				<form:label path="nom"><spring:message code="compagnie.edit.nom"/></form:label> <form:input type="text" class="form-control" path="nom"/>
